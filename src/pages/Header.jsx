...
function Header() {
    ...
    return (
        ...
        <header className="z-50 sticky w-full top-0 flex justify-between items-center px-12 py-4 ">
            ...
            <div className="flex gap-6">
                <Link to={'/login'} className="bg-indigo-500 text-base text-white px-6 py-2 font-bold shadow-xl rounded-xl hidden md:block hover:bg-indigo-700 active:scale-95 transition-colors">login</Link>
            </div>
        </header>
        </div>
    );
